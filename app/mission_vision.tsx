  ...
  return (
    <section className='container mx-auto px-4 sm:px-24 pb-18'>
        <div className="grid sm:grid-cols-2 gap-8 sm:gap-14">
            ...
            <div className="bg-[#AB832B] text-white p-8 rounded-lg">
